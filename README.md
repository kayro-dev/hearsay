...
A planted rumour bursts the price in roughly 45% of villages. A village nobody lied to does it too, in about one in three hundred — measured across nine hundred seeds, not assumed. Whether the lie caused the bubble is a question the counterfactual answers rather than a claim the model makes.
