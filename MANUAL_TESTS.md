...
| 12d | Sprint with `/tick sprint 800` — **one village day**, not `1d`, which is thirty — until three or more glow **red**, then sell into the famine | Watchers grow less sure the harvest failed, a little per sale: a 120-wheat bundle is 6 emeralds of evidence, and evidence saturates at 128. The counter pays what that one villager believes, so a Farmer who never heard the rumour pays 6 whatever the bar says |
